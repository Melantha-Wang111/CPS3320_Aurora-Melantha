...
# Q6: Accuracy:  According to the result, six of them has been recognized correctly. Hence, the accuracy will be recognized as 60%.
...
# store the result of recognization into list
# Personally written
result = {}
for i in range(1,11):
    path = r"D:\Finalpython\image\test" + str(i) + ".png"
